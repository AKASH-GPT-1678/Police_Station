  ...
  return (
    <div>
      ...
      <div className=' flex flex-col sm:flex-row gap-3 justify-between'>
        ...
        <select name="levels" id="levels" className='p-2 px-6 cursor-pointer'>
      ...
      <div className='flex flex-row flex-wrap gap-5 p-10 overflow-y-scroll h-screen '>
        ...
        <div className=' flex-col gap-4 rounded-lg flex flex-1'>
